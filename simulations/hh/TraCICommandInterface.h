...
public:
    ...
    //************* Quang-Huy Nguyen *******************
    // Person methods
    bool addPerson(std::string personId, std::string personTypeId, std::string edgeId, simtime_t emitTime_st = -DEPART_TIME_NOW, double emitPosition = -DEPART_POSITION_BASE);
    class VEINS_API Person {
    public:
        Person(TraCICommandInterface* traci, std::string personId) : traci(traci), personId(personId) {
    ...
    Person person(std::string personId) {
